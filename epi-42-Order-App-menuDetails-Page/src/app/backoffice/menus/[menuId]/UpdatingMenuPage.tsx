...
interface Props {
  ...
  selectedAddonCategories: number[] | undefined;
...
export default function UpdatingMenuPage({
  ...
  const menuImageUrl = menuToBeUpdatedOrDeleted.imageUrl
    ? menuToBeUpdatedOrDeleted.imageUrl
            ...
            {addonCategories.map((item) => (
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    defaultChecked={
                      selectedAddonCategories?.includes(item.id) ? true : false
                    }
